...
OpenTelemetry Java agent can send traces directly to Scry Cloud.
...
For Java application deployed on Kubernetes, you need to install OTel Collector agent in your k8s infra to collect and send traces to Scry Cloud. You can find the instructions to install OTel Collector agent [here](https://signoz.io/docs/tutorial/kubernetes-infra-metrics/).
...
You can validate if your application is sending traces to Scry cloud by following the instructions [here](https://signoz.io/docs/instrumentation/tomcat/#validating-instrumentation-by-checking-for-traces).
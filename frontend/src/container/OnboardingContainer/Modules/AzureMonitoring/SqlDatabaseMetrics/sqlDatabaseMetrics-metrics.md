...
Once you have completed the prerequisites, you can start monitoring your Database's system metrics with Scry. Here's how you can do it:
...
That's it! You have successfully set up monitoring for your Database's system metrics with Scry.

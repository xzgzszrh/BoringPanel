...
Scry 面向企业 Linux 与麒麟环境，将可观测数据、运维 Agent、MCP 工具和自动化流程整合到一个 Web 工作台。
...
当前仓库由 [@xzgzszrh](https://github.com/xzgzszrh) 维护。欢迎通过 [Issues](https://github.com/xzgzszrh/Scry/issues) 提交问题与建议，请附上复现步骤、部署环境及脱敏后的日志；安全问题请参阅 [SECURITY.md](SECURITY.md)。
